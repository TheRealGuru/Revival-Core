...
public class EKickCommand extends ECommand {
    ...
    public EKickCommand(Revival revival) {
        super(
                revival,
                "kick",
                "/kick <player> [reason]",
    ...
    public void onCommand(CommandSender sender, String args[]) {
        ...
        player.kickPlayer(getRevival().getMsgTools().getKickMessage(reason));

        getRevival().getPlayerTools().sendPermissionMessage(getRevival().getMsgTools().getMessage("punish-notifications.player-kicked")
