...
public class EListCommand extends ECommand {
    ...
    public EListCommand(Revival revival) {
        super(
                revival,
                "list",
                "/list",
    ...
    public void onCommand(CommandSender sender, String args[]) {
        ...
        List<Rank> ranksReversed = new ArrayList<>(getRevival().getRankManager().getRanks());
        ...
        for(Player players : Bukkit.getOnlinePlayers()) {
            if(getRevival().getRankManager().getRank(players) != null)
                playerList.put(players.getName(), getRevival().getRankManager().getRank(players));
            else
